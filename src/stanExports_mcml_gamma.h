...
static constexpr std::array<const char*, 28> locations_array__ =
  ...
  " (in 'string', line 7, column 16 to column 88)",
  " (in 'string', line 7, column 4 to column 88)",
  " (in 'string', line 8, column 16 to column 84)",
  " (in 'string', line 8, column 4 to column 84)",
  " (in 'string', line 9, column 16 to column 93)",
  " (in 'string', line 9, column 4 to column 93)",
...
partial_sum2_lpdf(const std::vector<T0__>& y, const int& start, const int&
  ...
  try {
    ...
    if (stan::math::logical_eq(type, 1)) {
      ...
      out = stan::math::gamma_lpdf<false>(
              stan::model::rvalue(y, "y",
                stan::model::index_min_max(1, ((1 + end) - start))), (1 /
              phi),
              stan::math::divide(1,
    ...
    if (stan::math::logical_eq(type, 2)) {
      ...
      out = stan::math::gamma_lpdf<false>(
              ...
              stan::math::divide(
                stan::model::rvalue(mu, "mu",
                  stan::model::index_min_max(1, ((1 + end) - start))), phi));
    }
        ...
        lp_accum__.add(stan::math::reduce_sum<partial_sum2_lpdf_rsfunctor__<false>>(
                         ...
                         stan::math::add(Xb,
                           stan::math::multiply(Z,
                             stan::math::to_vector(gamma))), var_par, type));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
