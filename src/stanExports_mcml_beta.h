...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 24, column 2 to column 87)",
...
T4__>
partial_sum2_lpdf(const std::vector<T0__>& y, const int& start,
                  const int& end, const T3__& mu_arg__, const T4__& phi,
...
struct partial_sum2_lpdf_functor__ {
template <bool propto__, typename T0__, typename T3__, typename T4__>
stan::promote_args_t<T0__, stan::value_type_t<T3__>,
T4__>
operator()(const std::vector<T0__>& y, const int& start, const int& end,
           const T3__& mu, const T4__& phi, const int& type,
           std::ostream* pstream__)  const 
{
return partial_sum2_lpdf<propto__>(y, start, end, mu, phi, type, pstream__);
}
};
template <bool propto__>
struct partial_sum2_lpdf_rsfunctor__ {
...
{
return partial_sum2_lpdf<propto__>(y, start + 1, end + 1, mu, phi, type,
         pstream__);
}
};
...
public:
  ...
  inline std::string model_name() const final { return "model_mcml_beta"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_mcml_beta(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mcml_beta_namespace::model_mcml_beta";
    ...
    try {
      ...
      validate_non_negative_index("logitmu", "N", N);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mcml_beta_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      logitmu = Eigen::Matrix<local_scalar_t__, -1, 1>(N);
      stan::math::fill(logitmu, DUMMY_VAR__);
      
      current_statement__ = 2;
      assign(logitmu, nil_index_list(),
        elt_divide(stan::math::exp(add(Xb, multiply(Z, to_vector(gamma)))),
          add(1.0, stan::math::exp(add(Xb, multiply(Z, to_vector(gamma)))))),
        "assigning variable logitmu");
      {
        ...
        lp_accum__.add(
          reduce_sum<partial_sum2_lpdf_rsfunctor__<false>>(y, grainsize,
            pstream__, logitmu, var_par, type));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mcml_beta_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      logitmu = Eigen::Matrix<double, -1, 1>(N);
      stan::math::fill(logitmu, std::numeric_limits<double>::quiet_NaN());
      ...
      if (emit_transformed_parameters__) {
        for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
          vars__.emplace_back(logitmu[(sym1__ - 1)]);}
      } 
  ...
  inline void constrained_param_names(
    ...
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        {
          param_names__.emplace_back(std::string() + "logitmu" + '.' + std::to_string(sym1__));
        }}
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gamma\",\"type\":{\"name\":\"array\",\"length\":" << Q << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"logitmu\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
