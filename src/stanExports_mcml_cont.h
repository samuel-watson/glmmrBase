...
namespace model_mcml_cont_namespace {
...
static constexpr std::array<const char*, 31> locations_array__ =
  ...
  " (in 'string', line 23, column 16 to column 76)",
  " (in 'string', line 23, column 2 to column 76)",
  " (in 'string', line 24, column 16 to column 81)",
  " (in 'string', line 24, column 2 to column 81)",
  " (in 'string', line 26, column 11 to column 12)",
  " (in 'string', line 26, column 4 to column 62)",
  " (in 'string', line 27, column 4 to column 64)",
  " (in 'string', line 25, column 15 to line 28, column 3)",
  " (in 'string', line 25, column 2 to line 28, column 3)",
  " (in 'string', line 29, column 14 to column 87)",
  " (in 'string', line 29, column 2 to column 87)",
  " (in 'string', line 30, column 14 to column 83)",
  " (in 'string', line 30, column 2 to column 83)",
  " (in 'string', line 31, column 14 to column 90)",
  " (in 'string', line 31, column 2 to column 90)",
...
class model_mcml_cont final : public model_base_crtp<model_mcml_cont> {
private:
  int N;
  int Q;
...
public:
  ~model_mcml_cont() {}
  model_mcml_cont(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mcml_cont_namespace::model_mcml_cont";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mcml_cont_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      gamma = in__.template read<std::vector<local_scalar_t__>>(Q);
      {
        ...
        if (stan::math::logical_eq(type, 2)) {
          ...
          lp_accum__.add(stan::math::normal_lpdf<propto__>(
                           stan::math::to_vector(stan::math::log(y)),
                           stan::math::add(Xb,
                             stan::math::multiply(Z,
                               stan::math::to_vector(gamma))),
                           stan::math::sqrt(sigma)));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mcml_cont_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_mcml_cont_namespace::model_mcml_cont;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mcml_cont_namespace::profiles__;
}
#endif
#endif
