...
namespace model_mcml_binomial_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 29, column 2 to column 85)",
...
template <bool propto__, typename T4__>
stan::promote_args_t<stan::value_type_t<T4__>>
partial_sum2_lpmf(const std::vector<int>& y, const int& start,
                  const int& end, const std::vector<int>& n,
                  const T4__& mu_arg__, const int& type,
...
operator()(const std::vector<int>& y, const int& start, const int& end,
           const std::vector<int>& n, const T4__& mu, const int& type,
           std::ostream* pstream__)  const 
{
return partial_sum2_lpmf<propto__>(y, start, end, n, mu, type, pstream__);
}
};
template <bool propto__>
struct partial_sum2_lpmf_rsfunctor__ {
...
stan::promote_args_t<stan::value_type_t<T4__>>
operator()(const std::vector<int>& y, const int& start, const int& end,
           std::ostream* pstream__, const std::vector<int>& n,
           const T4__& mu, const int& type)  const 
{
return partial_sum2_lpmf<propto__>(y, start + 1, end + 1, n, mu, type,
         pstream__);
}
};
#include <stan_meta_header.hpp>
class model_mcml_binomial final : public model_base_crtp<model_mcml_binomial> {
private:
  int N;
  int Q;
...
public:
  ...
  inline std::string model_name() const final { return "model_mcml_binomial"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_mcml_binomial(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mcml_binomial_namespace::model_mcml_binomial";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mcml_binomial_namespace::log_prob";
(void) function__;  // suppress unused var warning
          ...
          in__.scalar(), "assigning variable gamma");}
      {
        ...
        lp_accum__.add(
          reduce_sum<partial_sum2_lpmf_rsfunctor__<false>>(y, grainsize,
            pstream__, n, add(Xb, multiply(Z, to_vector(gamma))), type));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mcml_binomial_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_mcml_binomial_namespace::model_mcml_binomial;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mcml_binomial_namespace::profiles__;
}
#endif
#endif
