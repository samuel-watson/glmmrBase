...
partial_sum2_lpmf(const std::vector<int>& y, const int& start, const int&
                  end, const T3__& mu_arg__, const int& type, std::ostream*
                  pstream__);
...
partial_sum2_lpmf(const std::vector<int>& y, const int& start, const int&
  ...
  try {
    ...
    if (stan::math::logical_eq(type, 1)) {
      ...
      out = stan::math::bernoulli_logit_lpmf<false>(
              stan::model::rvalue(y, "y",
                stan::model::index_min_max(1, ((1 + end) - start))),
    ...
    if (stan::math::logical_eq(type, 2)) {
      ...
      out = stan::math::bernoulli_lpmf<false>(
              stan::model::rvalue(y, "y",
                stan::model::index_min_max(1, ((1 + end) - start))),
              stan::math::exp(
                stan::model::rvalue(mu, "mu",
...
public:
  ...
  model_mcml_bernoulli(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mcml_bernoulli_namespace::model_mcml_bernoulli";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mcml_bernoulli_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      gamma = in__.template read<std::vector<local_scalar_t__>>(Q);
      {
        ...
        lp_accum__.add(stan::math::reduce_sum<partial_sum2_lpmf_rsfunctor__<false>>(
                         y, grainsize, pstream__,
                         stan::math::add(Xb,
                           stan::math::multiply(Z,
                             stan::math::to_vector(gamma))), type));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mcml_bernoulli_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
