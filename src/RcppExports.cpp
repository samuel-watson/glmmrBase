...
void Model__set_optim_control(SEXP xp, bool direct, int max_iter, double epsilon, bool select_one, bool trisect_once, bool bobyqa, int max_eval, bool mrdirect, int type);
RcppExport SEXP _glmmrBase_Model__set_optim_control(SEXP xpSEXP, SEXP directSEXP, SEXP max_iterSEXP, SEXP epsilonSEXP, SEXP select_oneSEXP, SEXP trisect_onceSEXP, SEXP bobyqaSEXP, SEXP max_evalSEXP, SEXP mrdirectSEXP, SEXP typeSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type xp(xpSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type type(typeSEXP);
    Model__set_optim_control(xp, direct, max_iter, epsilon, select_one, trisect_once, bobyqa, max_eval, mrdirect, type);
    return R_NilValue;
END_RCPP
}
// Model__set_bound
...
SEXP Model__hessian_numerical(SEXP xp, double tol, int type);
RcppExport SEXP _glmmrBase_Model__hessian_numerical(SEXP xpSEXP, SEXP tolSEXP, SEXP typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type xp(xpSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type type(typeSEXP);
    rcpp_result_gen = Rcpp::wrap(Model__hessian_numerical(xp, tol, type));
    return rcpp_result_gen;
END_RCPP
}
// Model__xb
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_glmmrBase_Model__set_optim_control", (DL_FUNC) &_glmmrBase_Model__set_optim_control, 10},
    ...
    {"_glmmrBase_Model__hessian_numerical", (DL_FUNC) &_glmmrBase_Model__hessian_numerical, 3},
