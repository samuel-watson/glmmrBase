...
namespace model_mcml_int_namespace {
...
static constexpr std::array<const char*, 34> locations_array__ =
  ...
  " (in 'string', line 15, column 14 to column 59)",
  " (in 'string', line 15, column 2 to column 59)",
  " (in 'string', line 16, column 14 to column 58)",
  " (in 'string', line 16, column 2 to column 58)",
  " (in 'string', line 17, column 14 to column 53)",
  " (in 'string', line 17, column 2 to column 53)",
  " (in 'string', line 18, column 14 to column 65)",
  " (in 'string', line 18, column 2 to column 65)",
  " (in 'string', line 20, column 14 to column 61)",
  " (in 'string', line 20, column 2 to column 61)",
  " (in 'string', line 21, column 14 to column 59)",
  " (in 'string', line 21, column 2 to column 59)",
  " (in 'string', line 22, column 14 to column 54)",
  " (in 'string', line 22, column 2 to column 54)",
  " (in 'string', line 23, column 14 to column 66)",
  " (in 'string', line 23, column 2 to column 66)",
  " (in 'string', line 25, column 14 to column 55)",
  " (in 'string', line 25, column 2 to column 55)",
  ...
  " (in 'string', line 5, column 2 to column 16)",
...
class model_mcml_int final : public model_base_crtp<model_mcml_int> {
private:
  int N;
  int Q;
...
public:
  ~model_mcml_int() {}
  model_mcml_int(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mcml_int_namespace::model_mcml_int";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mcml_int_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      gamma = in__.template read<std::vector<local_scalar_t__>>(Q);
      {
        ...
        if (stan::math::logical_eq(type, 2)) {
          ...
          lp_accum__.add(stan::math::bernoulli_lpmf<propto__>(y,
                           stan::math::exp(
                             stan::math::add(Xb,
                               stan::math::multiply(Z,
                                 stan::math::to_vector(gamma))))));
        ...
        if (stan::math::logical_eq(type, 5)) {
          ...
          lp_accum__.add(stan::math::binomial_logit_lpmf<propto__>(y, n,
                           stan::math::add(Xb,
                             stan::math::multiply(Z,
                               stan::math::to_vector(gamma)))));
        }
        ...
        if (stan::math::logical_eq(type, 6)) {
          ...
          lp_accum__.add(stan::math::binomial_lpmf<propto__>(y, n,
                           stan::math::exp(
                             stan::math::add(Xb,
                               stan::math::multiply(Z,
                                 stan::math::to_vector(gamma))))));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mcml_int_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_mcml_int_namespace::model_mcml_int;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mcml_int_namespace::profiles__;
}
#endif
#endif
