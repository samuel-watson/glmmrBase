...
glmmr::ModelMatrix<modeltype>::ModelMatrix(modeltype& model_, glmmr::RandomEffects<modeltype>& re_): model(model_), W(model_), re(re_) { gen_sigma_blocks();};

template<typename modeltype>
glmmr::ModelMatrix<modeltype>::ModelMatrix(const glmmr::ModelMatrix<modeltype>& matrix) : model(matrix.model), W(matrix.W), re(matrix.re) { gen_sigma_blocks();};

template<typename modeltype>
glmmr::ModelMatrix<modeltype>::ModelMatrix(modeltype& model_, glmmr::RandomEffects<modeltype>& re_, bool useBlock_, bool useSparse_): model(model_), W(model_), re(re_) { 
  useBlock = useBlock_;
  useSparse = useSparse_;
  if(useBlock)gen_sigma_blocks();};

template<typename modeltype>
std::vector<glmmr::SigmaBlock> glmmr::ModelMatrix<modeltype>::get_sigma_blocks(){
  return sigma_blocks;
}

template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::information_matrix_by_block(int b){
...
template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::information_matrix(){
  W.update();
...
template<typename modeltype>
void glmmr::ModelMatrix<modeltype>::gen_sigma_blocks(){
  int block_counter = 0;
...
template<typename modeltype>
int glmmr::ModelMatrix<modeltype>::P() const {
  return model.linear_predictor.P();
}


template<typename modeltype>
int glmmr::ModelMatrix<modeltype>::Q() const {
  return model.covariance.Q();
}

template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::Sigma(bool inverse){
  W.update();
...
template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::sigma_block(int b,
                                                           bool inverse){
...
template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::sigma_builder(int b,
                                                             bool inverse){
...
MatrixXd glmmr::ModelMatrix<modeltype>::observed_information_matrix(){
...
template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::sandwich_matrix(){
...
template<typename modeltype>
std::vector<MatrixXd> glmmr::ModelMatrix<modeltype>::sigma_derivatives()
{
...
template<typename modeltype>
template<glmmr::IM imtype>
MatrixXd glmmr::ModelMatrix<modeltype>::information_matrix_theta()
{
  int n = model.n();
  std::vector<MatrixXd> derivs;
...
CorrectionData<corr> glmmr::ModelMatrix<modeltype>::small_sample_correction()
{
...
template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::linpred()
{
  return (re.zu_.colwise()+(model.linear_predictor.xb()+model.data.offset));
}

template<typename modeltype>
VectorMatrix glmmr::ModelMatrix<modeltype>::b_score()
{
...
// type = 2 - standardised
template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::residuals(const int type, bool conditional)
{
...
template<typename modeltype>
VectorMatrix glmmr::ModelMatrix<modeltype>::re_score(){
...
template<typename modeltype>
BoxResults glmmr::ModelMatrix<modeltype>::box(){
...
template<typename modeltype>
void glmmr::ModelMatrix<modeltype>::gradient_eta(const VectorXd &v,
...
template<typename modeltype>
VectorXd glmmr::ModelMatrix<modeltype>::log_gradient(const VectorXd &v,
                                                            bool betapars){
...
template<typename modeltype>
MatrixXd glmmr::ModelMatrix<modeltype>::hessian_nonlinear_correction(){
