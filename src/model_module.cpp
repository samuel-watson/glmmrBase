...
SEXP Model__new_from_bits(SEXP bptr_){
  ...
  XPtr<glmmr::Model<glmmr::ModelBits<glmmr::Covariance, glmmr::LinearPredictor> > > ptr(new glmmr::Model<glmmr::ModelBits<glmmr::Covariance, glmmr::LinearPredictor> >(*bptr),true);
  return ptr;
}
