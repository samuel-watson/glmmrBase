...
stan::promote_args_t<T0__, stan::base_type_t<T3__>, stan::base_type_t<T4__>>
partial_sum2_lpdf(const std::vector<T0__>& y, const int& start, const int&
                  end, const T3__& mu_arg__, const T4__& sigma_arg__,
...
public:
  ~model_mcml_gaussian() {}
  model_mcml_gaussian(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mcml_gaussian_namespace::model_mcml_gaussian";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mcml_gaussian_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mcml_gaussian_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
