...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 23, column 2 to column 58)",
                                                      " (in 'string', line 24, column 2 to column 90)",
...
partial_sum2_lpdf(const std::vector<T0__>& y, const int& start,
                  const int& end, const T3__& mu_arg__,
                  const T4__& sigma_arg__, std::ostream* pstream__) {
  using local_scalar_t__ = stan::promote_args_t<T0__,
...
{
return partial_sum2_lpdf<propto__>(y, start, end, mu, sigma, pstream__);
}
};
template <bool propto__>
struct partial_sum2_lpdf_rsfunctor__ {
...
stan::value_type_t<T4__>>
operator()(const std::vector<T0__>& y, const int& start, const int& end,
           std::ostream* pstream__, const T3__& mu, const T4__& sigma)  const 
{
return partial_sum2_lpdf<propto__>(y, start + 1, end + 1, mu, sigma,
         pstream__);
}
};
#include <stan_meta_header.hpp>
class model_mcml_gaussian final : public model_base_crtp<model_mcml_gaussian> {
private:
  int N;
  int Q;
...
public:
  ...
  inline std::string model_name() const final { return "model_mcml_gaussian"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mcml_gaussian_namespace::log_prob";
(void) function__;  // suppress unused var warning
          ...
          in__.scalar(), "assigning variable gamma");}
      {
        ...
        lp_accum__.add(
          reduce_sum<partial_sum2_lpdf_rsfunctor__<false>>(y, grainsize,
            pstream__, add(Xb, multiply(Z, to_vector(gamma))),
...
using stan_model = model_mcml_gaussian_namespace::model_mcml_gaussian;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mcml_gaussian_namespace::profiles__;
}
#endif
#endif
