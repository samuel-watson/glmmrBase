...
#include "stanExports_mcml_bernoulli.h"

RCPP_MODULE(stan_fit4mcml_bernoulli_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mcml_bernoulli")
