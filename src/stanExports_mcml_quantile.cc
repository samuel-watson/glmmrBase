...
#include "stanExports_mcml_quantile.h"

RCPP_MODULE(stan_fit4mcml_quantile_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mcml_quantile")
